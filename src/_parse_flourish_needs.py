...
html = open('../data/raw/climate_finance/_flourish_map_embed.html',
...
json.dump(data, open('../data/raw/climate_finance/_flourish_map_data.json', 'w',
                     encoding='utf-8'))
print('saved json')
...
df.to_csv('../data/raw/climate_finance/cpi_africa_needs_map.csv', index=False)
