"""One-time migration generator for ``data/raw/macro_variables/manual_imputation_values.csv``.
...
file ``macro_variables/manual_imputation_values.csv`` with columns:
...
_OUT = _RAW / "macro_variables/manual_imputation_values.csv"
