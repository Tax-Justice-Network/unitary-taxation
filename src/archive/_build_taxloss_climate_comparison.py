...
use = pd.read_csv("../data/raw/context/climate_finance/cpi_africa_country_use_2024.csv")
...
needs = pd.read_csv("../data/raw/context/climate_finance/cpi_africa_needs_map.csv")
...
out.to_csv(TABLES / "africa_taxloss_vs_context/climate_finance_and_needs.csv", index=False)
