# %%
"""
3_15 — Download World Bank natural-resource rents.

Download the World Bank World Development Indicators on natural-resource rents
(oil / gas / coal / mineral / forest / total rents, % of GDP, plus current-USD
GDP) via the WB API v2 and save a merged CSV with USD-level rent calculations.

Pipeline: Extractive prep, stage 3_15 — ingests the WB WDI rent indicators;
feeds the 3_2x rent-combination stage.

Reads:
  https://api.worldbank.org/v2/country/all/indicator/...  — WB WDI API v2 (rent + GDP indicators, 2000-2023)

Writes:
  data/raw/extractive/wb_resource_rents.csv               — iso3 x year rents (% GDP and USD)

Usage:
  python 3_15_download_wb_rents.py
...
# %% MARK: 4. Compute USD rents and write
...
out_path = RAW / "extractive" / "wb_resource_rents.csv"
