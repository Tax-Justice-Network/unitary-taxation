...
3_22, 3_23, 3_24, 3_24, 3_resource_contribution.py and 4_carveout.py — six
...
- Each mineral "ore/concentrate" HS code is priced at the benchmark *metal*
  ...
  concentrate value; the per-country rent-fraction calibration (3_22)
...
MINERAL_PRICES = {
    ...
    # 3_21_eiti_to_clean_panel.py categorises it as "other" (excluded from
...
# exists (calibrated values come from data/intermediate/extractive/rent_fractions_calibrated.csv).
