# %%
"""
3_26 — Apply carried-state classification fixes to the royalty panel (in place).
...
Pipeline: Extractive prep, stage 3_26 — after 3_25; feeds the 3_3x HQ x source chain
(3_38's GRD tier reads the panel this script fixes in place).

Reads:
  data/intermediate/extractive/extractive_royalty_dataset_yearly.csv — consolidated panel (3_25)
  data/raw/extractive/carried_state_classification_fixes.csv — hand-curated bucket corrections

Writes:
  data/intermediate/extractive/extractive_royalty_dataset_yearly.csv — in place, rebucketed
  data/intermediate/extractive/carried_state_classification_log.csv  — audit trail

Usage:
  python 3_26_apply_classification_fixes.py
...
FIXES = RAW / "extractive" / "carried_state_classification_fixes.csv"   # hand-curated
