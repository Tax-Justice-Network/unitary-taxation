"""
Parse EITI Summary Data XLSX files into a long-format production+exports table.

Input: data/raw/resources/eiti_reports/<Country>/FY<years> <Country> Summary Data*.xlsx
Output: data/raw/eiti_xlsx_production.csv  (one row per iso3 x year x commodity x measure)

Template variants supported:
  - v2 / "Summary Data v2.xlsx"     : sheets 'Part 2 - Disclosure checklist' has commodity rows
...
EITI_ROOT = RAW / "resources/eiti_reports"                    # external EITI XLSX templates
