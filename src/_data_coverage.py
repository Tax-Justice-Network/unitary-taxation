...
paper tables flag it (footnote [2]). The thresholds are data-sufficiency
minima — a partner needs a handful of cells, several distinct parents and
most of the window for a stable estimate; 37 countries fall below them:
